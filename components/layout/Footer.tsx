  ...
  return (
    <footer className="border-t border-[var(--border)]">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-6 sm:px-8 lg:px-12">
        <p className="font-serif text-sm text-[var(--muted-color)]" style={{ fontStyle: "italic" }}>
          Shuvo · {new Date().getFullYear()}
        </p>
        ...
        <div className="flex items-center gap-5">
          <a
            ...
            aria-label="GitHub"
            className="text-[var(--muted-color)] hover:text-[var(--foreground)] transition-colors duration-200"
          >
            <GitHubIcon size={15} />
          </a>
          <a
