...
export const metadata: Metadata = {
  title: "Experience",
  description: "Two years across two companies — from first production deployment to building solo products.",
};
...
function LogoPlaceholder({ accent, initials }: { accent: string; initials: string }) {
  return (
    <div
      ...
      style={{ width: 56, height: 56, background: accent, fontSize: "0.85rem", letterSpacing: "0.02em" }}
    >
      {initials}
    </div>
  );
      ...
      <div className="mx-auto max-w-7xl px-6 pt-32 sm:px-8 md:pt-40 lg:px-12 lg:pt-48">
        <div className="border-t border-[var(--border)] pt-14">
          ...
          <p className="mt-5 max-w-md text-sm leading-[1.85] text-[var(--muted-color)]">
            Two years across two companies before going independent.
            Every role shaped how I think about systems, ownership, and what it means for software to work.
          </p>
        </div>
      </div>
          ...
          return (
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-[var(--muted-color)]">{exp.tagline}</p>
                    </div>
                  ...
                  <div className="mt-3 flex items-center gap-3">
                    <span
                      className="text-xs tracking-[0.08em] px-2.5 py-1 border border-[var(--border)] text-[var(--muted-color)]"
                    >
                      {exp.type}
                    </span>
                    <div className="flex flex-wrap gap-2">
                      {exp.projects.map(p => (
                        <span
                          key={p}
                          className="text-xs tracking-[0.04em] px-2.5 py-1 text-[var(--muted-color)]"
              ...
              <div className="grid gap-12 lg:grid-cols-[55%_1fr] lg:gap-20">
                ...
                {/* Left: narrative + responsibilities */}
                <div>
                  {/* Pull quote / story */}
                  <div
                    className="border-l-2 pl-6 mb-10"
                    style={{ borderColor: exp.logoAccent }}
                  >
                ...
                <div className="space-y-10">
                  ...
                  {/* Tech */}
                  <div>
                    <p className="text-xs tracking-[0.2em] text-[var(--muted-color)] uppercase mb-4">
                      Technologies
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {exp.tech.map(t => (
                        <span
                          key={t}
                          className="text-xs tracking-[0.04em] border border-[var(--border)] px-2.5 py-1 text-[var(--muted-color)]"
                        >
                          {t}
                        </span>
                      ))}
        ...
        <div className="mt-20 border-t border-[var(--border)] py-16 lg:mt-28">
          <div className="flex items-start gap-5">
            ...
            <div
              ...
              style={{ width: 56, height: 56, border: "2px solid var(--color-accent)" }}
            >
            ...
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span
                  ...
                  style={{ background: `${`#10b981`}18`, color: "#10b981" }}
                >
                  Current
                </span>
              </div>
              <p className="text-sm text-[var(--muted-color)] mb-4">2024 – Present · Founder & Sole Engineer</p>
              <p className="text-sm leading-[1.85] text-[var(--muted-color)] max-w-xl">
                Left employment to build independently. Two products in production — Ezdu (gamified mobile learning)
                and Better IELTS (real-time exam preparation). Full ownership of product, engineering, and operations.
              </p>
            </div>
          </div>
        </div>
